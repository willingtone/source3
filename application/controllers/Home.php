...
class Home extends CI_Controller {
  ...
  function noticeboard() {
    ...
    $config['base_url']  = redirect('home/noticeboard/');
  ...
  function events() {
    ...
    $config['base_url']  = redirect('home/events/');
    $this->pagination->initialize($config);
  ...
  function teachers() {
    ...
    $config = manager($count_teachers, 9);
      $config['base_url']  = redirect('home/teachers/');
    $this->pagination->initialize($config);
  ...
  function gallery() {
    ...
    $config['base_url']  = redirect('home/gallery/');
    $this->pagination->initialize($config);
  ...
  function gallery_view($gallery_id = '') {
    ...
    $config['base_url']  = redirect('home/gallery_view/'.$gallery_id.'/');
    $this->pagination->initialize($config);
