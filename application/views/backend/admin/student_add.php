			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<label for="field-1" class="col-sm-1 control-label"><?php echo get_phrase('parent');?></label>
					...
					<div class="form-group">
						...
						<label for="field-2" class="col-sm-1 control-label"><?php echo get_phrase('roll');?></label>
						...
						<label for="field-2" class="col-sm-1 control-label"><?php echo get_phrase('birthday');?></label>
					...
					<div class="form-group">
						...
						<label for="field-2" class="col-sm-1 control-label"><?php echo get_phrase('address');?></label>
